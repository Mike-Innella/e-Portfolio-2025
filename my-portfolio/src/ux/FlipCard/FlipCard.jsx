...
export default function FlipCard({
  ...
  return (
    <>
      <div className="flipcard__wrapper">
        <div className="flipcard flex flex-row justify-center items-center w-92 h-48 p-0 mt-32 mb-48 max-lg:mx-auto max-lg:w-112 max-md:w-108 max-lg:h-24  max-md:h-28 max-lg:h-40 max-sm:w-fit max-sm:ml-0 max-sm:pl-0 max-sm:h-40 max-sm:w-full">
