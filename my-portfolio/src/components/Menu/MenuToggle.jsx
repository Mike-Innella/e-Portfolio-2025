  ...
  return (
    ...
    >
      ...
      <div className="menu-burger flex flex-col justify-center">
        <span
          className={`
            menu-burger-bar block w-3.5 h-0.5 rounded-full mb-0.5 transition-all duration-500
            ${
              menuActive
        ...
        <span
          className={`
            menu-burger-bar block w-3.5 h-0.5 rounded-full transition-all duration-500
            ${
              menuActive
                ? "rotate-[-35deg] -translate-y-[0.5em] translate-x-[-0.25em]"
                : ""
